...
abstract class AppLocalizations {
  ...
  /// No description provided for @activateThisPatient.
  ///
  /// In en, this message translates to:
  /// **'Activate this Patient'**
  String get activateThisPatient;

  /// No description provided for @deactivateThisPatient.
  ///
  /// In en, this message translates to:
  /// **'Deactivate this Patient'**
  String get deactivateThisPatient;
